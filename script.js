...
$(document).ready(function () {
  ...
  const APIKEY = "61d297bcccd0211b3208957d";
  getContacts();
  ...
  $("#contact-submit").on("click", function (e) {
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://funny-aad4.restdb.io/rest/contact",
  ...
  $("#update-contact-submit").on("click", function (e) {
    ...
    let contactstudentID = $("#update-contact-studentid").val(contactstudentID);
    let contactstudentMentor = $("#update-contact-studentmentor").val(contactstudentMentor);
    let contactstudentClass = $("#update-contact-studentclass").val(contactstudentClass);
    console.log($("#update-contact-msg").val());
    console.log(contactMsg);

    //[STEP 12a]: We call our update form function which makes an AJAX call to our RESTDB to update the selected information
    updateForm(contactId, contactName,contactstudentID,contactstudentMentor, contactstudentClass, contactEmail, contactMsg);
  });//end updatecontactform listener

  //[STEP 13]: function that makes an AJAX call and process it 
  //UPDATE Based on the ID chosen
  function updateForm(id, contactName, contactEmail, contactMsg, contactstudentClass, contactstudentID, contactstudentMentor) {
    //@TODO create validation methods for id etc. 

    var jsondata = { "name": contactName, "email": contactEmail, "message": contactMsg, "studentid": contactstudentID, "studentclass": contactstudentClass, "studentmentor": contactstudentMentor };
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://funny-aad4.restdb.io/rest/contact/${id}`,//update based on the ID
      "method": "PUT",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
